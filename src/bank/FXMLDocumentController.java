...
public class FXMLDocumentController implements Initializable {
    ...
    String selectedChoicegender = (String) gender.getSelectionModel().getSelectedItem();
     ...
     {
         Bank.Person person=bm.new Admain (firstname.getText()+" "+lastname.getText(),email.getText()
                 ,selectedChoicegender,"","",password.getText());
         person.Display();
     }  
     else if(selectedChoice.equals("Employee"))
     {
         Bank.Person person=bm.new Employee(firstname.getText()+" "+lastname.getText(),email.getText()
                 ,selectedChoicegender,"","",password.getText());;
         person.Display();
     }
     else if(selectedChoice.equals("Client"))
     {
        Bank.Person person=bm.new Client(firstname.getText()+" "+lastname.getText(),email.getText()
                ,selectedChoicegender,"","",password.getText());;
         person.Display();
